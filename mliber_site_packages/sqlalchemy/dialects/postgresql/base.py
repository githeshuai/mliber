...
:func:`~sqlalchemy.database_api.expression.insert()` construct is executed using
...
Will generate on the backing database_api as::
...
.. seealso::
    ...
    `INSERT .. ON CONFLICT
    <http://www.postgresql.org/docs/current/static/database_api-insert.html#SQL-ON-CONFLICT>`_
...
the actual name of the column as expressed in the database_api.
...
When using CONCURRENTLY, the PostgreSQL database_api requires that the statement
...
The PostgreSQL database_api creates a UNIQUE INDEX implicitly whenever the
...
.. seealso::
    ...
    <http://www.postgresql.org/docs/current/static/database_api-createtable.html>`_
...
class ENUM(sqltypes.NativeForEmulated, sqltypes.Enum):
    ...
    def __init__(self, *enums, **kw):
        ...
        :param create_type: Defaults to True.
         ...
         without access to the actual database_api -
